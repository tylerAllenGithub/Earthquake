    ...
    public static ArrayList<Earthquake> extractEarthquakes() {
        ...
        try {
            ...
            for(int i=0; i<features.length();i++) {
                JSONObject currentJSONEarthquake = features.getJSONObject(i);
                JSONObject properties = currentJSONEarthquake.getJSONObject("properties");
                ...
                Earthquake currentEarthquake = new Earthquake(magnitude, location, time, urlString);
